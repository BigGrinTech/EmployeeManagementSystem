...
class CreateEmployeeComponent extends Component {
    ...
    saveOrUpdateEmployee = (e) => {
        e.preventDefault();
        let employee = {firstName: this.state.firstName, lastName: this.state.lastName, department: this.state.department , designation: this.state.designation, phone: this.state.phone, salary: this.state.salary};
